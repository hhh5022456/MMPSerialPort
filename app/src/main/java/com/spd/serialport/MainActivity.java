...
//                .setMaxLength(4096)
        ...
        ;
        serialManager.setGpioPowerPath("/sys/devices/platform/pinctrl/mt_gpio");
        serialManager.setGpioPowerList(new ArrayList<Integer>() {
            {
                add(2);
                add(115);
            }
